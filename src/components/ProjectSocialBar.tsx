...
export default function ProjectSocialBar({ onOpenCV }: ProjectSocialBarProps) {
  ...
  const buttons = [
    ...
    { id: 1, label: "Instagram", icon: <InstagramIcon className="w-5 h-5" />, href: "https://instagram.com" },
    { id: 2, label: "LinkedIn", icon: <LinkedinIcon className="w-5 h-5" />, href: "https://linkedin.com" },
